...
The <<_predefined_client_and_endpoint_configurations>>
...
https://docs.jboss.org/author/display/AS71/Web+services+configuration[webservices
...
link:#sid-41713670[endpoint configuration] . Endpoint configuration are
...
related
https://docs.jboss.org/author/display/AS71/Web+services+configuration[documentation]
.
...
associated to a JBossWS link:#sid-41713670[predefined configuration]
...
See link:#sid-83919125[Published WSDL customization] .
...
link:#sid-3866716[???] section of the documentation for getting started.
...
link:#sid-3866738[provide property values] .
...
http://cxf.apache.org/javadoc/latest-2.5.x/org/apache/cxf/workqueue/AutomaticWorkQueueImpl.html#AutomaticWorkQueueImpl(int, int, int, int, long, java.lang.String)[AutomaticWorkQueueImpl
constructor] :
...
current deployment. Further details available link:#sid-66486377[here] .
...
interceptors within link:#sid-41713670[predefined client and endpoint
...
adds an additional descriptor based approach to avoid requiring
modifications to the actual client/endpoint code. Users can declare
features within link:#sid-41713670[predefined client and endpoint
...
image::author/download/attachments/3866795/Public_key_making.png[TODO
InformalFigure image title empty]
...
image::author/download/attachments/3866795/Public_key_encryption-mod.svg.png[TODO
InformalFigure image title empty]
...
image::author/download/attachments/3866795/250px-Public_key_making.svg.png[TODO
InformalFigure image title empty]
...
link:#sid-3866786[As well as for other WS-* features] , the core of
...
a defined _endpoint configuration_ . link:#sid-41713670[Endpoint
...
link:#sid-47972359_WS-TrustandSTS-WebserviceproviderImplementation[here]
.
...
The ActAs scenario is an extension of link:#sid-78711224[the basic
...
The OnBehalfOf scenario is an extension of link:#sid-78906783[the basic
WS-Trust scenario] . In this example the OnBehalfOf service calls the
ws-service on behalf of a user. There are only a couple of additions to
...
link:#sid-78906783_OnBehalfOfWS-TrustScenario-WebservicerequesterImplementation[the
...
link:#sid-4784150[dependency] to the the `org.apache.cxf.impl` module is
